...
data_path <- "C:/Users/wb637898/OneDrive - WBG/Documents/GitHub/jennifer07-1/R"

# Run the R scripts ----

source("Code/01-processing-data_jr.R")
source("Code/02-constructing-data_jr.R")
source("Code/03-analyzing-data_jr.R")
